#!/bin/bash
#SBATCH -J fast_s                         # Job name
#SBATCH -o sbatch_logs/out/fast_s.o%j          # Name of stdout output file
#SBATCH -e sbatch_logs/err/fast_s.e%j          # Name of stderr error file
...
ROOT=$SCRATCH/dpdm/paper_shear/fast
...
[setup]
  ...
  drive = "resonance"
  loading = "quiet"            # SHEARING loader: lattice positions, sampled
                               # velocities, decoheres to the Poisson floor by
                               # wp t ~ 1 (gate job 3447505). NOT the old
                               # permanently-ordered one, now called quiet_lattice.
