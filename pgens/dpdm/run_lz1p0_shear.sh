#!/bin/bash
#SBATCH -J lz1p0_s
#SBATCH -o sbatch_logs/out/lz1p0_s.o%j
#SBATCH -e sbatch_logs/err/lz1p0_s.e%j
...
ROOT=$SCRATCH/dpdm/lz_shear/lz1p0
...
[setup]
  ...
  drive        = "landau_zener"
  loading      = "quiet"             # SHEARING loader (gate job 3447505):
                                     # lattice positions, sampled velocities,
                                     # decoheres to the Poisson floor by wp t ~ 1.
                                     # The old permanent lattice is quiet_lattice.
  one_v        = true
  A0           = 3.16228e-2
  omega0       = 0.8
  domega_dt    = 2.0e-5
