#!/bin/bash
#SBATCH -J dpdm_slow                         # Job name
#SBATCH -o sbatch_logs/out/slow.o%j          # Name of stdout output file
#SBATCH -e sbatch_logs/err/slow.e%j          # Name of stderr error file
...
#SBATCH -t 48:00:00                          # Run time: measured 36.8 h, cap is 48 h
...
S=$(date +%s)
cd $ROOT && $EXE -input slow.toml > slow.stdout 2>&1
rc=$?
