#!/bin/bash
#SBATCH -J dpdm_grow
#SBATCH -o sbatch_logs/out/grow.o%j
#SBATCH -e sbatch_logs/err/grow.e%j
...
EOF
S=$(date +%s)
( cd $ROOT && $EXE -input grow.toml > grow.stdout 2>&1 ); rc=$?
echo "GROW rc=$rc wall=$(( $(date +%s) - S ))s for 500 steps"
echo "GROW_DONE"
