#!/bin/bash
#SBATCH -J dpdm_gpu
#SBATCH -o sbatch_logs/out/gpu.o%j
#SBATCH -e sbatch_logs/err/gpu.e%j
...
run small  20000.0  2.1e7      # 4e7 particles, ~2.3 GB  -- always fits
run full   200000.0 2.05e8     # 4e8 particles, ~23 GB   -- the real slow config
echo "GPUBENCH_DONE"
