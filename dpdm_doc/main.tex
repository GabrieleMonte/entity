...
\paragraph{In progress.} Landau--Zener at $v_q^D/\vth = 1.0$ has completed the full
sweep to $\wpt = 2\times10^4$ (2:39:32 on one A100, 500 field and 500 particle dumps);
its analysis is pending. The $0.1$ case is written and gated on that analysis.

Note that the $1.0$ case took 2:39:32 against an estimate of ${\sim}2$\,h --- it would
not have fitted a 2\,h queue. The estimate predated the post-saturation slowdown of
